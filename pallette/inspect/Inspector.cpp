/*************************************************************************
  ...
  > Created Time: 2019年07月04日 星期四 09时58分45秒
 ************************************************************************/

#include <pallette/inspect/Inspector.h>
#include <pallette/inspect/ProcessInspector.h>
...
#include <pallette/http/HttpResponse.h>

using namespace pallette;

namespace
{
    Inspector* gGlobalInspector = 0;
...
{
    assert(current_thread::isMainThread());//要在主线程中
    assert(gGlobalInspector == 0);
    gGlobalInspector = this;
    server_.setHttpCallback(std::bind(&Inspector::onRequest, this, _1, _2));//协议解析之后的回调
