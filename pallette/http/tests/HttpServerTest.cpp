/*************************************************************************
  > File Name: HttpServerTest.cpp
  > Author: pengjunjie
  > Mail: 1002398145@qq.com
  > Created Time: 2019年07月03日 星期三 19时16分58秒
 ************************************************************************/

#include <pallette/http/HttpServer.h>
...
void onRequest(const HttpRequest& req, HttpResponse* resp)
{
    ...
    if (!benchmark)
    {
        ...
        {
            LOG_INFO << headerValue.first << ":" << headerValue.second;
        }
    }
    ...
    if (req.path() == "/")
    {
        ...
        resp->addHeader("Server", "Pallette");
